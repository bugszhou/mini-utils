(function (global, factory) {
  ...
  function showModal(){var opts=0<arguments.length&&arguments[0]!==void 0?arguments[0]:{},platform=getPlatform();return "aliapp"===platform?getGlobal().alert(opts):getGlobal().showModal(opts)}
