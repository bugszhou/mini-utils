(function (global, factory) {
  ...
  var globalObj=getGlobal(),defaultTitle="\u66F4\u65B0\u63D0\u793A",defaultContent="\u65B0\u7248\u672C\u5DF2\u7ECF\u51C6\u5907\u597D\uFF0C\u662F\u5426\u91CD\u542F\u5E94\u7528\uFF1F",defaultCconfirmText="\u4F7F\u7528\u65B0\u7248";function updateApp(){var _ref=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{reLaunch:"/pages/index/index",showCancel:!1},reLaunchPage=_ref.reLaunchPage,title=_ref.title,content=_ref.content,confirmText=_ref.confirmText,showCancel=_ref.showCancel,updateManager=globalObj.getUpdateManager();return updateManager.onCheckForUpdate(function(res){console.log(res.hasUpdate);}),updateManager.onUpdateReady(function(){showModal({title:title||defaultTitle,content:content||defaultContent,showCancel:showCancel,confirmText:confirmText||defaultCconfirmText,success:function success(_ref2){var confirm=_ref2.confirm;confirm&&updateManager.applyUpdate();}});}),updateManager.onUpdateFailed(function(){globalObj.reLaunch({url:reLaunchPage});}),updateManager}
